...
import { Validation, Validators } from './../../src/index';
import { CompareOperator } from './../../src/validation/Validation/enums';
import { ICOValidator } from './../../src/customValidators/ICOValidator';
import { IPropertyValidator, IAsyncPropertyValidator } from './../../src/validation/Validation/interfaces';
 ...
 */
class BranchOfBusinessValidator implements IAsyncPropertyValidator {
...
class DateCompareExtValidator extends dateCompareValidator {
    ...
    private isValid(now:any, then:any, compareOperator: CompareOperator) {
        var isValid = false;
     ...
     */
    public CompareOperator2: CompareOperator;
...
describe('custom validators', function () {
    ...
    describe('create new custom validator', function () {
        ...
        companyValidator.RuleFor("BranchOfBusiness", <any>branchOfBusiness);
